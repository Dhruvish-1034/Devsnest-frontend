...
// var student = { name: "Ted Mosby", sclass: "VI", rollno: 12 };
// Sample Output: name,sclass,rollno
// let keys = Object.keys(student);
// keys.forEach((key) => console.log(key));

// 2. Write a JavaScript program to delete the rollno property from the following object. Also print the object before or after
//deleting the property. Sample object:
...
// let myCylinder = new Cylinder(5, 7);
